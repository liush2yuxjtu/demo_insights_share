...
- 最新本机加强门当前包含 52 项合同测试、adoption proof（含 AP-2 relevance-lift matrix）、`start.demo.sh --dry-run`、Playwright handout verify、tmux claude/codex smoke。
...
- AP-2 完成后，当前权威口径更新为：无开放 E2E 阻塞项、52 项合同测试、本机加强门全过、默认 release/PR 收尾、adoption proof 已包含 AP-2 relevance-lift matrix、无 `:7821/:18821` 残留监听、仅 `.claude/settings.local.json` 未跟踪。
